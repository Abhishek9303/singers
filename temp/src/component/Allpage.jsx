      ...
      <div id="main">
            ...
            <div className="p4center">
              <div className="tourdates">
                ...
                <div className="p4ticketprice">
                  ...
                  <button>
                    {" "}
                    Buy Now <i class="ri-ticket-2-line"></i>
                  </button>
                </div>
              </div>
              <div className="tourdates">
        ...
        <div id="page7">
          ...
          <div className="p7center">
            <div className="p7img">
              <img
                src="https://img.youtube.com/vi/XEEasR7hVhA/maxresdefault.jpg"
                alt=""
              />
              <a href="https://youtu.be/qw2LU1yS7aw" target="blank">
                <i class="ri-play-fill"></i>
            ...
            <div className="p7img">
              <img
                src="https://img.youtube.com/vi/mhJh5_6MuCk/maxresdefault.jpg"
                alt=""
              />
              <a href="https://youtu.be/qw2LU1yS7aw" target="blank">
                <i class="ri-play-fill"></i>
            ...
            <div className="p7img">
              <img
                src="https://img.youtube.com/vi/5abamRO41fE/maxresdefault.jpg"
                alt=""
              />
              <a href="https://youtu.be/qw2LU1yS7aw" target="blank">
                <i class="ri-play-fill"></i>
            ...
            <div className="p7img">
              <img
                src="https://img.youtube.com/vi/6fVE8kSM43I/maxresdefault.jpg"
                alt=""
              />
              <a href="https://youtu.be/qw2LU1yS7aw" target="blank">
                <i class="ri-play-fill"></i>
            ...
            <div className="p7img">
              <img
                src="https://img.youtube.com/vi/LXEKuttVRIo/maxresdefault.jpg"
                alt=""
              />
              <a href="https://youtu.be/qw2LU1yS7aw" target="blank">
                <i class="ri-play-fill"></i>
            ...
            <div className="p7img">
              <img
                src="https://img.youtube.com/vi/D1jQKpse7Yw/maxresdefault.jpg"
                alt=""
              />
              <a href="https://youtu.be/qw2LU1yS7aw" target="blank">
                <i class="ri-play-fill"></i>
